...
export class ReclamosService {
  ...
  // tslint:disable-next-line:typedef
  cargarReclamos() {
    return this.http.get<Reclamos[]>('http://localhost:3001/reclamos');
  }

  // tslint:disable-next-line:typedef
  cargarReclamosDeUnUsuario(rut: string) {
    return this.http.get<Reclamos[]>('http://localhost:3001/getReclamosByRut/?rut=' + rut);
  }

  // tslint:disable-next-line:typedef
  agregarReclamoDeUsuario(reclamo: Reclamos) {
    return this.http.post<Reclamos>('http://localhost:3001/addReclamos', reclamo);
  }
// tslint:disable-next-line:typedef
